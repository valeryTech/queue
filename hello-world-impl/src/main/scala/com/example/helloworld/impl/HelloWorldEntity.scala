...
/**
  * This is an event sourced entity. It has a state, [[HelloWorldState]], which
...
/**
  * This interface defines all the events that the HelloWorldEntity supports.
  */
...
/**
  * This interface defines all the commands that the HelloWorldEntity supports.
  */
